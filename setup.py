...
_LIBS = 'python-numpy python-dev python-pyglet cmake zlib1g-dev libjpeg-dev xvfb libav-tools xorg-dev python-opengl libboost-all-dev libsdl2-dev swig'.split()
...
setup(
    ...
    description='human following robot',
    cmdclass={
